Public Class MemoriaSul
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For i = 0 To 15 Step 1
            ...
            PBs(i).ImageLocation = "Sul\sul.jpg"
            PBs(i).Enabled = True
        Next
    ...
    Private Sub PreSelecionaImagem()
        ...
        PbAtual.ImageLocation = "Sul\" & ImgAtual & ".jpg"
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If VericaAcerto() = False Then
            ...
            PbAtual.ImageLocation = "Sul\sul.jpg"
            PbAtual.Enabled = True
            UltPb.ImageLocation = "Sul\sul.jpg"
            UltPb.Enabled = True
        End If
