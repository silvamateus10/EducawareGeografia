Public Class MemoriaNordeste
    ...
    Private Sub PreSelecionaImagem()
        ...
        PbAtual.ImageLocation = "Nordeste\" & ImgAtual & ".jpg"
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If VericaAcerto() = False Then
            ...
            PbAtual.ImageLocation = "Nordeste\nordeste.jpg"
            PbAtual.Enabled = True
            UltPb.ImageLocation = "Nordeste\nordeste.jpg"
            UltPb.Enabled = True
        End If
