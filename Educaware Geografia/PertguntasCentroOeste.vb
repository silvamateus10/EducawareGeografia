Public Class PerguntasCentroOeste
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        inseriu = pergBanco.InserirPerguntaCentro(perg)
    ...
    Private Sub btnOKalt_Click(sender As Object, e As EventArgs) Handles btnOKalt.Click
        ...
        Else
            ...
            linhaselecionada = dgvPerguntasCentro.CurrentRow
    ...
    Private Sub txtNumQuestãoAlt_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestãoAlt.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumero(txtNumQuestãoAlt.Text)
        dgvPerguntasCentro.DataSource = dadosPergunta
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        alterou = pergBanco.alterarPerguntasCentro(perg)
