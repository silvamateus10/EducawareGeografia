Public Class ExcluirPerguntaNorte

    Private Sub ExcluirPerguntaNorte_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtNumQuestExc_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestExc.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumeroNorte(txtNumQuestExc.Text)
        dgvExcluirNorte.DataSource = dadosPergunta
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Else
            ...
            If MessageBox.Show("Deseja realmente excluir?", _
                ...
                apagou = pergBanco.excluirPerguntaNorte(numero)
