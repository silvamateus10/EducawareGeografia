Public Class QuizNordeste
    ...
    Private Sub QuizNordeste_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dt = pergBanco.chamarPerguntasNordeste(1)
        txtQuestao.Text = dt.Rows(0).Item("pergunta")

        'Dim resp As String
        dt = pergBanco.trazerAlternativaNordeste(1)
    ...
    Private Sub lblContinuar_Click(sender As Object, e As EventArgs) Handles lblContinuar.Click
        ...
        Dim mem As New MemoriaNordeste
...
sorteia_de_novo:
        ...
        dt = pergBanco.chamarPerguntasNordeste(Numero)
        txtQuestao.Text = dt.Rows(0).Item("pergunta")

        dt = pergBanco.trazerAlternativaNordeste(Numero)
        lblA.Text = dt.Rows(0).Item("alternativa_A")
        lblB.Text = dt.Rows(0).Item("alternativa_B")
        lblC.Text = dt.Rows(0).Item("alternativa_C")
        lblD.Text = dt.Rows(0).Item("alternativa_D")
