...
Public Class QuizSudeste
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dt = pergBanco.chamarPerguntasSudeste(1)
        txtQuestao.Text = dt.Rows(0).Item("pergunta")

        'Dim resp As String
        dt = pergBanco.trazerAlternativaSudeste(1)
...
sorteia_de_novo:
        ...
        dt = pergBanco.chamarPerguntasSudeste(Numero)
        txtQuestao.Text = dt.Rows(0).Item("pergunta")

        dt = pergBanco.trazerAlternativaSudeste(Numero)
        lblA.Text = dt.Rows(0).Item("alternativa_A")
        lblB.Text = dt.Rows(0).Item("alternativa_B")
        lblC.Text = dt.Rows(0).Item("alternativa_C")
        lblD.Text = dt.Rows(0).Item("alternativa_D")
