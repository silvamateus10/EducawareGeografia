Public Class PerguntasNordeste
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        inseriu = pergBanco.InserirPerguntaNordeste(perg)
    ...
    Private Sub btnOKalt_Click(sender As Object, e As EventArgs) Handles btnOKalt.Click
        ...
        Else
            ...
            linhaselecionada = dgvPerguntasNordeste.CurrentRow

            txtNumQuestãoAlt.Text = linhaselecionada.Cells(0).Value
            txtQuestaoAlt.Text = linhaselecionada.Cells(1).Value
            txtRespAlt.Text = linhaselecionada.Cells(2).Value
            txtOPAalt.Text = linhaselecionada.Cells(3).Value
            txtOPBalt.Text = linhaselecionada.Cells(4).Value
            txtOPCalt.Text = linhaselecionada.Cells(5).Value
            txtOPDalt.Text = linhaselecionada.Cells(6).Value
    ...
    Private Sub txtNumQuestãoAlt_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestãoAlt.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumeroNordeste(txtNumQuestãoAlt.Text)
        dgvPerguntasNordeste.DataSource = dadosPergunta
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        alterou = pergBanco.alterarPerguntasNordeste(perg)
