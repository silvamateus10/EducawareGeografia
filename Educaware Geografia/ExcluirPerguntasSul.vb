Public Class ExcluirPerguntasSul
    ...
    Private Sub txtNumQuestExc_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestExc.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumeroSul(txtNumQuestExc.Text)
        dgvExcluirSul.DataSource = dadosPergunta
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Else
            ...
            If MessageBox.Show("Deseja realmente excluir?", _
                ...
                apagou = pergBanco.excluirPerguntaSul(numero)
