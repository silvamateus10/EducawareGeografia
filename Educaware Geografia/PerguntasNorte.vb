Public Class PerguntasNorte
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        inseriu = pergBanco.InserirPerguntaNorte(perg)
    ...
    Private Sub btnOKalt_Click(sender As Object, e As EventArgs) Handles btnOKalt.Click
        ...
        Else
            ...
            linhaselecionada = dgvPerguntasNorte.CurrentRow
    ...
    Private Sub txtNumQuestãoAlt_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestãoAlt.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumeroNorte(txtNumQuestãoAlt.Text)
        dgvPerguntasNorte.DataSource = dadosPergunta
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        alterou = pergBanco.alterarPerguntasNorte(perg)
