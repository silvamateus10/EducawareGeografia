Public Class PerguntasSudeste
    ...
    Private Sub btnSalvar_Click(sender As Object, e As EventArgs) Handles btnSalvar.Click
        ...
        inseriu = pergBanco.InserirPerguntaSudeste(perg)
    ...
    Private Sub btnOKalt_Click(sender As Object, e As EventArgs) Handles btnOKalt.Click
        ...
        Else
            ...
            linhaselecionada = dgvPerguntasSudeste.CurrentRow
    ...
    Private Sub txtNumQuestãoAlt_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestãoAlt.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumeroSudeste(txtNumQuestãoAlt.Text)
        dgvPerguntasSudeste.DataSource = dadosPergunta
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        perg.numPergunta = txtNumQuestãoAlt.Text
            ...
            alterou = pergBanco.alterarPerguntasSudeste(perg)
