Public Class QuizNorte
    ...
    Private Sub QuizNorte_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dt = pergBanco.chamarPerguntasNorte(1)
        txtQuestao.Text = dt.Rows(0).Item("pergunta")

        'Dim resp As String
        dt = pergBanco.trazerAlternativaNorte(1)
...
sorteia_de_novo:
        ...
        dt = pergBanco.chamarPerguntasNorte(Numero)
        txtQuestao.Text = dt.Rows(0).Item("pergunta")

        dt = pergBanco.trazerAlternativaNorte(Numero)
        lblA.Text = dt.Rows(0).Item("alternativa_A")
        lblB.Text = dt.Rows(0).Item("alternativa_B")
        lblC.Text = dt.Rows(0).Item("alternativa_C")
        lblD.Text = dt.Rows(0).Item("alternativa_D")
