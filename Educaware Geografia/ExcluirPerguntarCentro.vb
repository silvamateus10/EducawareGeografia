Public Class ExcluirPerguntarCentro
    ...
    Private Sub ExcluirPerguntarCentro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Else
            ...
            If MessageBox.Show("Deseja realmente excluir?", _
                ...
                apagou = pergBanco.excluirPerguntaCentro(numero)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs)
        ...
        linhaselecionada = dgvExcluirCentro.CurrentRow
    ...
    Private Sub txtNumQuestExc_TextChanged(sender As Object, e As EventArgs) Handles txtNumQuestExc.TextChanged
        ...
        dadosPergunta = pergBanco.localizarPorNumero(txtNumQuestExc.Text)
        dgvExcluirCentro.DataSource = dadosPergunta
